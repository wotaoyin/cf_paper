...
\end{thm} 
The explicit formulas for $\eta_{\min}$ and $\eta_{\max}$, the proof of Theorem~\ref{thm:async-convergence}, and some other remarks are included in Appendix \ref{pf:pdasync}.
}